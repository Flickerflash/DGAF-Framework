...
| **Agent Lyra** | Lyra | Narrative + Expression | Extended | Narrative coherence; IMP-05 brand voice consistency (P-19); portfolio language quality | Narrative authority |
| **Agent Herald** | Herald | Communication + Release | Extended | External publication gate; changelog authorship; release notes; inter-agent status broadcast | Release authority |

---

## Formation Activation Map

| Formation | Agents | Activates When |
|-----------|--------|----------------|
| **Trio (P-14)** | Amethyst + Apogee + COLLEEN | Any session touching ≥ 3 repos or requiring cross-repo delta |
| **Harmonic Quintet (P-15)** | Trio + Reson + Sentinel | SWEEP_LOG seal commit; sovereign file touch; NDR Registry update; new public repo; Reson score < 0.75 |
| **Extended Formation** | Quintet + any of Reciprocity, Prof Prodigy, DemiJoule, Echolette, Lyra, Herald | Domain-specific tasks: formal proofs, rollback operations, brand review, release, cost audit |
...
| Agent | Deprecated | Replaced By | Notes |
|-------|------------|-------------|-------|
| Lavender | 2026-04-29 | Agent Amethyst | Full rename sweep completed S011 |
| Forseti | 2026-04-29 | Agent Sentinel | Role absorbed; CI/CD duties retained |

> Any reference to Lavender or Forseti in any file is a **hard BLG** — trigger P-01 immediately.
...
*Roster authority: Amethyst-Conductor. Changes require Njineer confirmation.*
